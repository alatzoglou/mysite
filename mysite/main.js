...
(function() {
	...
	// "On Visible" animations.
		onvisible.add('.image.style1', { style: 'zoom-out', speed: 3000, intensity: 10, delay: 0, replay: true });
		onvisible.add('h1.style1, h2.style1, h3.style1, p.style1', { style: 'zoom-in', speed: 3000, intensity: 10, delay: 0, replay: true });
		onvisible.add('#text02', { style: 'zoom-in', speed: 3000, intensity: 10, delay: 0, replay: true });
		onvisible.add('#text04', { style: 'zoom-in', speed: 3000, intensity: 10, delay: 0, replay: true });
		onvisible.add('#text01', { style: 'zoom-in', speed: 3000, intensity: 10, delay: 0, replay: true });
		onvisible.add('#buttons01', { style: 'zoom-in', speed: 0, intensity: 0, delay: 0, replay: true });
